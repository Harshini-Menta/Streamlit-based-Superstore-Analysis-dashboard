...
with col1:
    ...
    fig = px.bar(category_df, x = "Category", y = "Sales",color="Category", text = ['${:,.2f}'.format(x) for x in category_df["Sales"]], template = "seaborn",color_discrete_sequence=px.colors.sequential.Viridis)
